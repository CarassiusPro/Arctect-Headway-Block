...
jQuery(document).ready(function()
{
    ...
    jQuery('#line-custom').click(function (e)
    {
        e.preventDefault();
    ...
    jQuery('#line-no-scale').click(function (e)
    {
        e.preventDefault();
    ...
    jQuery('#ellipse-above').click(function (e)
    {
        e.preventDefault();
    ...
    jQuery('#ellipse-below').click(function (e)
    {
        e.preventDefault();
    ...
    jQuery('#ellipse-custom').click(function (e)
    {
        e.preventDefault();
    ...
    jQuery('#sine-no-rotation').click(function (e)
    {
        e.preventDefault();
    ...
    jQuery('#damped-sine').click(function (e)
    {
        e.preventDefault();
    ...
    jQuery('#damped-sine-no-scale').click(function (e)
    {
        e.preventDefault();
    ...
    jQuery('#power-spiral').click(function (e)
    {
        e.preventDefault();
